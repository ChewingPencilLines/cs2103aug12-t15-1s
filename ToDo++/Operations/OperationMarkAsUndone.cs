...
namespace ToDo
{
    class OperationMarkAsUndone : Operation
    {
        ...
        #region Constructors      
        /// <summary>
        /// This is the constructor for the MarkAsUndone operation which accepts arguments
        ...
        /// This operation tries to mark one or more tasks as undone using
        /// the given parameters.
        /// If an index exist, it will mark all tasks by index.
        /// If not, it will perform a search, marking tasks immediately
        /// if the isAll flag is set.
        /// </summary>
